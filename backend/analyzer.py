...
## 7. 매출 목표 시뮬레이션
아래 3가지 시나리오로 월 매출을 시뮬레이션해줘. 시장 데이터 기반으로 현실적인 수치 사용.

| 시나리오 | 월 판매량(개) | 월 매출 | 연간 매출 | 근거 |
|---------|------------|--------|---------|------|
| 보수적 | ... | ... | ... | ... |
| 표준 | ... | ... | ... | ... |
| 낙관적 | ... | ... | ... | ... |
...
## 8. 마케팅 전략
{brand_name} 신제품 런칭을 위한 핵심 전략 요약.
...
## 5. 차별화 전략 요약
{brand_name} vs 주요 경쟁사를 한눈에 비교하는 요약 테이블.

| 비교 항목 | 경쟁사 최고 수준 | {brand_name} 목표 | 우위 |
|---------|--------------|----------------|-----|
| 가격 | ... | ... | O/X |
| 인증 수 | ... | ... | O/X |
| USP 수 | ... | ... | O/X |
